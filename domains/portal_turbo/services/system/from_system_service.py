"""
Service to handle system metadata (portal_system.json) for Portal Turbo
"""
...
class PortalTurboFromSystemService:
    """Service to load and process system metadata (portal_system.json)"""
    ...
    def _load_system_metadata(self, system_metadata_path: Path) -> Dict[str, Any]:
        """
        Load and process system metadata (portal_system.json)
        
        Args:
            system_metadata_path: Path to portal_system.json
