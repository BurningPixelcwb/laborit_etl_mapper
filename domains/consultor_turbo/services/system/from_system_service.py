"""
Service to handle system metadata (consultor_system.json) for Consultor Turbo
"""
...
class ConsultorTurboFromSystemService:
    """Service to load and process system metadata (consultor_system.json)"""
    ...
    def _load_system_metadata(self, system_metadata_path: Path) -> Dict[str, Any]:
        """
        Load and process system metadata (consultor_system.json)
        
        Args:
            system_metadata_path: Path to consultor_system.json
