#!/usr/bin/env python3
"""
Script para converter consolidated_metadata.json do Consultor Turbo para CSV
"""
...
def main():
    """Converte consolidated_metadata.json do Consultor Turbo para CSV"""
    
    # Caminhos
    json_path = BASE_DIR / "output" / "consultor_turbo" / "consolidated_metadata" / "consolidated_metadata.json"
    output_dir = BASE_DIR / "output" / "consultor_turbo" / "consolidated_csv"
    output_dir.mkdir(parents=True, exist_ok=True)
    csv_path = output_dir / "consultor_turbo_consolidated_metadata.csv"
