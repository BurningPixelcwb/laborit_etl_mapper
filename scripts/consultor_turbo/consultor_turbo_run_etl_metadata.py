#!/usr/bin/env python3
"""
Script para gerar apenas os metadados ETL do Consultor Turbo
"""
...
def main():
    """Gera apenas os metadados ETL em JSON para Consultor Turbo"""
    
    project_name = 'consultor_turbo'
    
    print("=" * 70)
    print("🚀 Gerando Metadados ETL - Consultor Turbo")
    print("=" * 70)
    ...
    try:
        ...
        json_file = output_path / "etl_metadata" / "consultor_etl_metadata.json"
