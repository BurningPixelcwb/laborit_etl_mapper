#!/usr/bin/env python3
"""
Script para comparar metadados S3 vs ETL do Consultor Turbo
"""
...
def main():
    """Compara metadados S3 vs ETL para Consultor Turbo"""
    
    project_name = 'consultor_turbo'
    
    print("=" * 70)
    print("🚀 Comparando Metadados S3 vs ETL - Consultor Turbo")
    print("=" * 70)
    ...
    try:
        ...
        if not etl_metadata_path.exists():
            ...
            print(f"💡 Execute primeiro: python3 scripts/consultor_turbo/consultor_turbo_run_etl_metadata.py")
            return 1
        
        if not s3_metadata_path.exists():
            print(f"❌ JSON de metadados S3 não encontrado: {s3_metadata_path}")
            print(f"💡 Execute primeiro: python3 scripts/consultor_turbo/consultor_turbo_run_s3_metadata.py")
            return 1
