#!/usr/bin/env python3
"""
Script para publicar metadados consolidados JSON do Consultor Turbo diretamente no Confluence
"""
...
try:
    ...
    from domains.confluence_integration.services import ConsultorTurboJsonPublicationService
...
def main():
    """Publica metadados consolidados JSON do Consultor Turbo diretamente no Confluence"""
    
    project_name = 'consultor_turbo'
    
    print("=" * 70)
    print("🚀 Publicando Metadados Consolidados JSON no Confluence - Consultor Turbo")
    print("=" * 70)
    ...
    try:
        ...
        if not consolidated_json_path.exists():
            ...
            print(f"💡 Execute primeiro: python3 scripts/consultor_turbo/consultor_turbo_run_consolidated_metadata.py")
            return 1
